...
export const CHRONOS_PACKS = [
  ...
  { id: 'standard', chronos: 500, price: '$4.99', bonus: 50, popular: true },       // 500 + 50 = 550 total
  { id: 'value', chronos: 850, price: '$9.99', bonus: 150, popular: true },         // 850 + 150 = 1000 total (max)
] as const
