      ...
      >
        ...
        <div className="px-4 py-3 border-b border-white/[0.08] flex items-center gap-6">
          ...
          {!isOwnProfile && (
            <button
              ...
              className={`flex-shrink-0 px-4 py-2 rounded-lg text-sm font-medium transition-all flex items-center gap-2 ${
                isFollowing
                  ? 'bg-teal-500/15 text-slate-300 border border-teal-500/20 hover:bg-teal-500/20'
          ...
          <button
            ...
            className="flex-shrink-0 px-4 py-2 rounded-lg text-sm font-medium bg-gradient-to-r from-teal-500 to-cyan-400 text-white hover:from-teal-400 hover:to-cyan-400 transition-all flex items-center gap-2"
          >
