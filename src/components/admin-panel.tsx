...
export function AdminPanel() {
  ...
  const [ageFilter, setAgeFilter] = useState('') // 'under18' or '18plus'
  ...
  }, [activeTab, usersPage, usersSearch, roleFilter, ageFilter])
    ...
    <div className="h-full flex flex-col persona-bg">
      ...
      <div className="p-6 border-b border-white/5 bg-black/30">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-white/50">Manage users, content, and platform settings</p>
          </div>
        </div>
      </div>
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="h-full flex flex-col">
          <div className="px-6 pt-4 border-b border-white/5">
            <TabsList className="bg-white/5 border border-white/10">
              ...
              <TabsTrigger value="chronos" className="data-[state=active]:bg-white/10">
            ...
            {stats && (
              <>
                  ...
                  <Card className="bg-white/[0.02] border-white/10">
                    <CardContent className="p-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p className="text-2xl font-bold text-white/90">{stats.totalUsers}</p>
                  ...
                  <Card className="bg-white/[0.02] border-white/10">
                    <CardContent className="p-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p className="text-2xl font-bold text-white">{stats.totalStorylines}</p>
                          <p className="text-xs text-gray-400/60">Storylines</p>
                        </div>
                      </div>
                    </CardContent>
                  </Card>
                  ...
                  <Card className="bg-white/5 border-white/15">
                    <CardContent className="p-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p className="text-2xl font-bold text-white">{stats.totalChronosInCirculation.toLocaleString()}</p>
                          <p className="text-xs text-gray-400/60">Chronos in Circulation</p>
                        </div>
                      </div>
                    </CardContent>
                  </Card>
                    ...
                    <CardContent className="p-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-gray-400/60">Pending Reports</p>
                        </div>
                      </div>
                    </CardContent>
                  </Card>
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                  <Card className="bg-white/5 border-white/15">
                    <CardContent className="p-4">
                      <p className="text-sm text-gray-400/60">Messages Sent</p>
                      <p className="text-xl font-semibold text-white">{stats.totalMessages.toLocaleString()}</p>
                      <p className="text-xs text-gray-400/40 mt-1">DM: {stats.dmMessages} • Storyline: {stats.storylineMessages}</p>
                    </CardContent>
                  </Card>
                  
                  <Card className="bg-white/5 border-white/15">
                    <CardContent className="p-4">
                      <p className="text-sm text-gray-400/60">Total Personas</p>
                      <p className="text-xl font-semibold text-white">{stats.totalPersonas.toLocaleString()}</p>
                    </CardContent>
                  </Card>
                  
                  <Card className="bg-white/5 border-white/15">
                    <CardContent className="p-4">
                      <p className="text-sm text-gray-400/60">New Users (7d)</p>
                      <p className="text-xl font-semibold text-white">{stats.recentUsers}</p>
                    </CardContent>
                  </Card>
                  
                  <Card className="bg-white/5 border-white/15">
                    <CardContent className="p-4">
                      <p className="text-sm text-gray-400/60">Transactions (7d)</p>
                      <p className="text-xl font-semibold text-white">{stats.recentTransactions}</p>
                    </CardContent>
                  </Card>
                </div>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <Card className="bg-white/5 border-white/15">
                      <CardHeader className="pb-2">
                        <CardTitle className="text-lg text-white">New Users (Last 7 Days)</CardTitle>
                      </CardHeader>
                      <CardContent>
                          ...
                          {charts.newUsersPerDay.map((day, i) => {
                            ...
                            return (
                              <div key={i} className="flex-1 flex flex-col items-center gap-1">
                                <div 
                                  className="w-full bg-gradient-to-t from-white to-gray-400 rounded-t-sm transition-all"
                                  style={{ height: `${Math.max(height, 4)}%` }}
                                />
                                <span className="text-[10px] text-gray-400/60">
                                  {new Date(day.date).toLocaleDateString('en', { weekday: 'short' })}
                                </span>
                                <span className="text-xs text-gray-300">{day.count}</span>
                              </div>
                            )
                          })}
                        </div>
          ...
          <TabsContent value="users" className="flex-1 overflow-y-auto p-6">
            ...
            <div className="flex gap-4 mb-6">
              <div className="flex-1 relative">
                ...
                <Input
                  ...
                  className="pl-10 bg-white/5 border-white/15 focus:border-white"
                />
              </div>
              <select
                value={roleFilter}
                onChange={(e) => { setRoleFilter(e.target.value); setUsersPage(1) }}
                className="px-4 rounded-lg bg-white/5 border border-white/15 text-white focus:border-white focus:outline-none"
              >
              ...
              <select
                value={ageFilter}
                onChange={(e) => { setAgeFilter(e.target.value); setUsersPage(1) }}
                className="px-4 rounded-lg bg-white/5 border border-white/15 text-white focus:border-white focus:outline-none"
              >
                <option value="">All Ages</option>
                <option value="under18">Under 18 Only</option>
                ...
                >
                  <div className="flex items-center gap-4">
                    <Avatar className="w-12 h-12 border-2 border-white/20">
                      ...
                      <AvatarFallback className="bg-gradient-to-br from-gray-600 to-gray-400 text-white font-semibold">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-2">
                        ...
                        {/* Age and NSFW Eligibility badges */}
                        {u.age !== null && (
                          <span className={`px-2 py-0.5 rounded text-xs ${u.isAdult ? 'bg-emerald-500/20 text-emerald-400' : 'bg-amber-500/20 text-amber-400'}`}>
                            {u.age}y
                          </span>
                        )}
                        {u.isAdult ? (
                      ...
                      <div className="flex items-center gap-2 mt-1">
                        <span className="text-xs text-gray-400/40 font-mono">ID: {u.id}</span>
                        <button
                        ...
                        >
                          {copiedUserId === u.id ? (
                            ...
                            <Copy className="w-3 h-3 text-gray-400/60 hover:text-gray-300" />
                          )}
                        </button>
                      </div>
                      <div className="flex items-center gap-4 mt-1 text-sm text-gray-400/60">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      {canChangeRoles && u.id !== currentUser?.id && hasHigherRole(currentUserRole, u.role) ? (
                        <select
                          ...
                          className="px-3 py-1.5 rounded-lg bg-white/5 border border-white/15 text-sm text-white focus:border-white focus:outline-none"
            ...
            {usersTotal > 10 && (
              <div className="flex items-center justify-center gap-4 mt-6">
                ...
                <span className="text-gray-400">Page {usersPage} of {Math.ceil(usersTotal / 10)}</span>
                <Button
                  variant="ghost"
              ...
              <Card className="bg-white/5 border-white/15">
                <CardContent className="p-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-2xl font-bold text-white">{stats?.recentTransactions || 0}</p>
                      <p className="text-xs text-gray-400/60">Transactions (7d)</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="bg-white/5 border-white/15">
                <CardContent className="p-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-2xl font-bold text-white">{transactions.filter(t => t.amount > 0).length}</p>
                      <p className="text-xs text-gray-400/60">Credits Shown</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="bg-white/5 border-white/15">
                <CardContent className="p-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-2xl font-bold text-white">{transactions.filter(t => t.amount < 0).length}</p>
                      <p className="text-xs text-gray-400/60">Deductions Shown</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
              ...
              <CardContent>
                <div className="space-y-2">
                  {transactions.map((tx) => (
                    <div 
                      key={tx.id}
                      className="flex items-center gap-4 p-3 rounded-xl bg-white/5 border border-white/10 hover:border-white/15 transition-colors"
                    >
                      <Avatar className="w-10 h-10 border-2 border-white/20">
                        <AvatarImage src={tx.user.avatarUrl || undefined} />
                        <AvatarFallback className="bg-gradient-to-br from-gray-600 to-gray-400 text-white text-sm font-semibold">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-sm text-gray-400/60 truncate">{tx.description}</p>
                      </div>
                      ...
                      <div className="text-xs text-gray-400/40 whitespace-nowrap">
                  ...
                  {transactions.length === 0 && (
                    <div className="text-center py-12">
                      <Coins className="w-12 h-12 mx-auto mb-4 text-gray-500/30" />
                      <p className="text-gray-400/60">No transactions found</p>
                    </div>
                  )}
                </div>
          ...
          <TabsContent value="reports" className="flex-1 overflow-y-auto p-6">
                ...
                >
                  <div className="flex items-start gap-4">
                    <div className={`w-10 h-10 rounded-lg flex items-center justify-center ${
                      ...
                      report.status === 'dismissed' ? 'bg-gray-500/20' : 'bg-white/10'
                    }`}>
                      <Flag className={`w-5 h-5 ${
                        report.status === 'pending' ? 'text-amber-400' :
                        report.status === 'resolved' ? 'text-emerald-400' :
                        report.status === 'dismissed' ? 'text-gray-400' : 'text-gray-400'
                      }`} />
                    </div>
                    
                    <div className="flex-1">
                      <div className="flex items-center gap-2">
                        <span className="font-semibold text-white">{report.type.toUpperCase()}</span>
                      ...
                      <p className="text-gray-200 mt-1">{report.reason}</p>
                      {report.details && (
                        <p className="text-sm text-gray-400/60 mt-1">{report.details}</p>
                      )}
                      <div className="flex items-center gap-4 mt-2 text-xs text-gray-400/50">
                        {report.reporter && (
            ...
            {reportsTotal > 10 && (
              <div className="flex items-center justify-center gap-4 mt-6">
                ...
                <span className="text-gray-400">Page {reportsPage}</span>
                <Button
                  variant="ghost"
          ...
          <TabsContent value="commands" className="flex-1 overflow-y-auto p-4">
            <Card className="bg-[#0a0510] border-white/15 flex flex-col overflow-hidden min-h-[400px]">
              <CardHeader className="pb-2 border-b border-white/10 shrink-0">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    <Terminal className="w-5 h-5 text-gray-400" />
                    <CardTitle className="text-lg text-white">Admin Command Prompt</CardTitle>
                  </div>
                  <Button
                    variant="ghost"
                    size="sm"
              ...
              <CardContent className="flex flex-col overflow-hidden p-0 min-h-0">
                  ...
                  <div className="font-mono text-sm space-y-2">
                    {commandHistory.length === 0 && (
                      <div className="text-gray-400/60">
                        ...
                        <p className="mt-2">Type <span className="text-gray-300">-Help</span> to see available commands.</p>
                        <p className="mt-1 text-xs text-gray-400/40">
                    ...
                    {commandHistory.map((entry, index) => (
                      <div key={index} className={`${entry.type === 'input' ? 'text-gray-300' : entry.success ? 'text-emerald-400' : 'text-red-400'}`}>
                        {entry.type === 'input' ? (
                          ...
                          <div className="whitespace-pre-wrap break-all ml-4 pl-2 border-l-2 border-white/20">
                            {entry.content}
                          </div>
                        )}
                      </div>
                    ...
                    {isExecutingCommand && (
                      <div className="text-gray-400/60 animate-pulse">
                        Executing...
                      </div>
                    )}
                  </div>
                ...
                {/* Command Input */}
                <form onSubmit={executeCommand} className="p-4 border-t border-white/10 shrink-0">
                  <div className="flex gap-2">
                    <span className="text-gray-500 font-mono py-2">$</span>
                    <Input
                      value={commandInput}
                      onChange={(e) => setCommandInput(e.target.value)}
                      placeholder="Enter command (e.g., -Help)"
                      className="flex-1 bg-white/5 border-white/15 font-mono text-white placeholder-gray-500/40 focus:border-white"
            ...
            {/* Quick Reference */}
            <Card className="mt-4 bg-white/5 border-white/15">
              <CardHeader className="pb-2">
                <CardTitle className="text-sm text-gray-200">Quick Reference</CardTitle>
              </CardHeader>
              <CardContent className="grid grid-cols-2 md:grid-cols-3 gap-2 text-xs">
                <div className="p-2 rounded bg-white/5">
                  <code className="text-gray-300">-CreateAccount Username, Password, Role</code>
                </div>
                <div className="p-2 rounded bg-white/5">
                  <code className="text-gray-300">-ChangeKey Username</code>
                </div>
                <div className="p-2 rounded bg-white/5">
                  <code className="text-gray-300">-GetUserInfo Username</code>
                </div>
                <div className="p-2 rounded bg-white/5">
                  <code className="text-gray-300">-SetRole Username, Role</code>
                </div>
                <div className="p-2 rounded bg-white/5">
                  <code className="text-gray-300">-GiveChronos Username, Amount</code>
                </div>
                <div className="p-2 rounded bg-white/5">
      ...
      {selectedReport && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm p-4">
          <div className="w-full max-w-lg rounded-2xl bg-gradient-to-b from-[#150a25] to-[#0a0510] border border-white/15 shadow-2xl overflow-hidden">
            ...
            <div className="p-6 space-y-4">
              <div>
                <label className="text-xs text-gray-400/60 uppercase tracking-wider">Type</label>
                <p className="text-white">{selectedReport.type.toUpperCase()}</p>
              </div>
              
              <div>
                <label className="text-xs text-gray-400/60 uppercase tracking-wider">Reason</label>
                <p className="text-white">{selectedReport.reason}</p>
              </div>
              
              {selectedReport.details && (
                <div>
                  <label className="text-xs text-gray-400/60 uppercase tracking-wider">Details</label>
                  <p className="text-white">{selectedReport.details}</p>
                </div>
              )}
              
              <div>
                <label className="text-xs text-gray-400/60 uppercase tracking-wider">Note</label>
                <textarea
                  value={reportNote}
                  onChange={(e) => setReportNote(e.target.value)}
                  placeholder="Add a note about this decision..."
                  className="w-full mt-1 p-3 rounded-lg bg-white/5 border border-white/15 text-white placeholder-gray-500/40 focus:border-white focus:outline-none resize-none"
                  rows={3}
                />
              </div>
              ...
              <div className="flex gap-2 pt-4">
                <Button
                  ...
                  variant="ghost"
                  className="flex-1 border border-white/15 text-gray-300 hover:bg-white/5"
                >
