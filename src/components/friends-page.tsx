  ...
  return (
    <div className="flex flex-col h-full persona-bg">
      ...
      <div className="h-14 border-b border-white/[0.08] flex items-center px-4 gap-4 bg-[#0f1117]/50 backdrop-blur-sm">
        ...
        <div className="w-px h-6 bg-teal-500/15" />
                ...
                {searchResult && (
                  <div className="mt-3 p-3 rounded-lg bg-white/[0.05] border border-white/[0.08] flex items-center gap-3">
                    <Avatar className="w-10 h-10 border-2 border-teal-500/20">
                      ...
                      <AvatarFallback className="bg-gradient-to-br from-teal-500/40 to-cyan-500/50 text-white font-medium">
                        ...
                        <div className="flex items-start gap-4">
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <div className="p-3 rounded-lg bg-white/[0.03] border border-white/[0.06]">
                              <p className="text-sm text-slate-200/80 line-clamp-2">{req.firstMessage}</p>
                            </div>
                          </div>
                        </div>
                    ...
                    {sentRequests.map(req => (
                      <div key={req.id} className="persona-card p-4 flex items-center gap-4 opacity-75">
                        <Avatar className="w-12 h-12 border-2 border-white/[0.08]">
                          ...
                          <AvatarFallback className="bg-gradient-to-br from-teal-500/20 to-cyan-500/20 text-white font-medium">
