                ...
                {searchResult && (
                  <div className="mt-3 p-3 rounded-lg bg-purple-500/10 border border-purple-500/20 flex items-center gap-3">
                    ...
                    <div className="flex-1">
                      <p className="font-semibold text-purple-100">{searchResult.username}</p>
                      {searchResult.activePersona?.name && (
                        <p className="text-xs text-purple-400/70">as {searchResult.activePersona.name}</p>
                      )}
                    </div>
                    {(() => {
                      const { canSend, reason } = canSendRequest(searchResult)
                        ...
                        <div className="flex items-start gap-4">
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="flex items-center gap-2">
                              <p className="font-semibold text-purple-100">{req.sender.name}</p>
                              <span className="text-xs text-purple-400/60">@{req.sender.username}</span>
                            </div>
                            <p className="text-xs text-cyan-400/70 mb-2">wants to start a conversation</p>
                            <div className="p-3 rounded-lg bg-purple-500/5 border border-purple-500/10">
                              <p className="text-sm text-purple-200/80 line-clamp-2">{req.firstMessage}</p>
                            </div>
                          </div>
                        </div>
              ...
              <div>
                ...
                {pendingRequests.length === 0 ? (
                  <div className="persona-empty-state persona-card">
                    ...
                    <p className="text-purple-300/60">No incoming requests</p>
                  </div>
                ) : (
                  <div className="space-y-3">
              ...
              <div>
                ...
                {sentRequests.length === 0 ? (
                  <div className="persona-empty-state persona-card">
                    ...
                    <p className="text-purple-300/60">No sent requests</p>
                  </div>
                ) : (
                  <div className="space-y-3">
                    {sentRequests.map(req => (
                      <div key={req.id} className="persona-card p-4 flex items-center gap-4 opacity-75">
                        <Avatar className="w-12 h-12 border-2 border-purple-500/20">
                          ...
                          <AvatarFallback className="bg-gradient-to-br from-purple-500/30 to-fuchsia-500/30 text-white font-medium">
                            {req.receiver.username.charAt(0).toUpperCase()}
                          </AvatarFallback>
                        </Avatar>
                        <div className="flex-1">
                          <p className="font-semibold text-purple-100">{req.receiver.username}</p>
                          <p className="text-xs text-purple-400/60">Pending response</p>
                        </div>
                        <button
                  ...
                  <div key={friend.id} className="persona-card persona-card-hover p-4 flex items-center gap-4 group">
                    ...
                    <div className="flex gap-1 opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none">
                      ...
                      <button
                        ...
                        className="w-9 h-9 rounded-lg flex items-center justify-center text-purple-400/60 hover:text-purple-300 hover:bg-purple-500/10 transition-all pointer-events-auto"
                        title="Message"
                      >
                        <MessageCircle className="w-4 h-4" />
                      </button>
                      <button
                        ...
                        className="w-9 h-9 rounded-lg flex items-center justify-center text-purple-400/60 hover:text-red-400 hover:bg-red-500/10 transition-all pointer-events-auto"
                        title="Remove friend"
                      >
                        <X className="w-4 h-4" />
                      </button>
