...
export function StorylineSettings({ storylineId, onClose, onUpdate }: StorylineSettingsProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="w-full max-w-4xl h-[90vh] bg-[#0e1015] rounded-xl border border-white/[0.08] shadow-2xl flex overflow-hidden">
        {/* Sidebar */}
        <div className="w-56 border-r border-white/[0.08] bg-[#0a0512] flex flex-col">
          ...
          <div className="flex-1 overflow-y-auto p-6">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <Input
                      ...
                      className="bg-[#0f1117] border-teal-500/20 text-slate-100"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <Textarea
                      ...
                      rows={2}
                      disabled={!canChangeSettings}
                      className="bg-[#0f1117] border-teal-500/20 text-slate-100 resize-none"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <select
                      ...
                      disabled={!canChangeSettings}
                      className="w-full px-3 py-2 rounded-lg bg-[#0f1117] border border-teal-500/20 text-slate-100 focus:outline-none focus:ring-2 focus:ring-teal-500"
                    >
                  ...
                  <div className="flex items-center justify-between p-3 rounded-lg bg-[#0f1117] border border-white/[0.08]">
                    <div>
                    ...
                    <button
                      ...
                      className={`w-12 h-6 rounded-full transition-all ${
                        isPublic ? 'bg-teal-500' : 'bg-teal-500/15'
                  ...
                  <div className="flex items-center justify-between p-3 rounded-lg bg-[#0f1117] border border-white/[0.08]">
                    ...
                    <button
                      ...
                      disabled={!canChangeSettings}
                      className={`w-12 h-6 rounded-full transition-all ${
                        requireApproval ? 'bg-teal-500' : 'bg-teal-500/15'
                      } ${canChangeSettings ? 'cursor-pointer' : 'opacity-50 cursor-not-allowed'}`}
                    >
                      <div className={`w-5 h-5 rounded-full bg-white transition-all ${
                  ...
                  <div>
                    ...
                    <div className="flex gap-3">
                      <input
                        ...
                        disabled={!canChangeSettings}
                        className="w-12 h-10 rounded-lg cursor-pointer border border-teal-500/20"
                      />
                      <Input
                        value={accentColor}
                        onChange={(e) => setAccentColor(e.target.value)}
                        disabled={!canChangeSettings}
                        className="flex-1 bg-[#0f1117] border-teal-500/20 text-slate-100"
                      />
                    </div>
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-3">
                  ...
                  {storyline.categories.map(cat => (
                    <div key={cat.id} className="p-3 rounded-lg bg-[#0f1117] border border-white/[0.08]">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex gap-2">
                      ...
                      <select
                        ...
                        className="px-3 py-2 rounded-lg bg-[#0f1117] border border-teal-500/20 text-slate-100"
                      >
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-2">
                  {storyline.roles.sort((a, b) => b.position - a.position).map(role => (
                    <div key={role.id} className="flex items-center gap-3 p-3 rounded-lg bg-[#0f1117] border border-white/[0.08]">
            ...
            {activeTab === 'invites' && (
              <div className="space-y-6">
                ...
                <div className="space-y-2">
                  {storyline.invites.length === 0 ? (
                    ...
                    storyline.invites.map(invite => (
                      <div key={invite.id} className="flex items-center gap-3 p-3 rounded-lg bg-[#0f1117] border border-white/[0.08]">
                ...
                {canInvite && (
                  <div className="p-4 rounded-lg bg-[#0f1117] border border-white/[0.08] space-y-3">
                    ...
                    <div className="flex gap-3">
                      <div>
                        ...
                        <Input
                          ...
                          className="w-28 bg-[#0e1015] border-teal-500/20 text-slate-100"
                        />
                      </div>
                      <div>
                        ...
                        <select
                          ...
                          className="px-3 py-2 rounded-lg bg-[#0e1015] border border-teal-500/20 text-slate-100"
                        >
            ...
            {activeTab === 'boosters' && canChangeSettings && (
              <div className="space-y-6">
                ...
                {/* Tier Progress */}
                {boostStats && (
                  <div className="p-4 rounded-xl bg-[#0f1117] border border-white/[0.08] space-y-3">
                  ...
                  {isLoadingBoosters ? (
                    ...
                    <div className="space-y-2">
                      {boosters.map(booster => (
                        <div key={booster.id} className="flex items-center gap-3 p-3 rounded-lg bg-[#0f1117] border border-white/[0.08]">
