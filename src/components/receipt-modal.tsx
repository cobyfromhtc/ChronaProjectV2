  ...
  return (
    <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <DialogContent className="max-w-md p-0 bg-transparent border-0 shadow-none overflow-visible">
        ...
        <div className="bg-gradient-to-br from-purple-900/95 via-purple-800/95 to-purple-900/95 rounded-2xl border border-purple-500/30 shadow-2xl shadow-purple-500/20 overflow-hidden">
          {/* Header */}
          <div className="bg-gradient-to-r from-purple-600/50 to-purple-500/50 px-6 py-4 border-b border-purple-400/20">
