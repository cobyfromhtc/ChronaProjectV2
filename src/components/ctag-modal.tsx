...
const TAG_STYLES = [
  ...
  { id: 'radiant', name: 'Radiant', description: 'Glowing, vibrant appearance', preview: 'bg-gradient-to-r from-gray-400 to-pink-300' },
...
export function CTagModal({ open, onOpenChange, user, activePersona, personas, onSuccess }: CTagModalProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[500px] bg-[#0a0510] border-white/15 text-white">
        <DialogHeader>
        ...
        <form onSubmit={handleSubmit} className="space-y-6 mt-4">
          ...
          <div className="p-4 rounded-xl bg-white/5 border border-white/10">
            <div className="flex items-center gap-4">
              <Avatar className="w-16 h-16 border-2 border-white/20">
                ...
                <AvatarFallback className="bg-gradient-to-br from-white to-gray-300 text-white font-bold text-xl">
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center gap-2 mt-1 text-sm text-gray-400/60">
                  <User className="w-3 h-3" />
                  <span className="font-mono">ID: {user.id}</span>
                </div>
                {activePersona && (
                  <div className="text-sm text-gray-400/60 mt-1">
          ...
          <div className="space-y-2">
            ...
            <div className="grid gap-2 max-h-40 overflow-y-auto">
              {personas.map((persona) => (
                ...
                >
                  <Avatar className="w-8 h-8 border border-white/20">
                    ...
                    <AvatarFallback className="bg-gradient-to-br from-white to-gray-300 text-white text-xs">
              ...
              {personas.length === 0 && (
                <div className="text-center py-4 text-gray-400/60">
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              maxLength={50}
              className="bg-white/5 border-white/15 focus:border-white text-white placeholder-gray-500/40"
            />
            <p className="text-xs text-gray-400/40">{tagText.length}/50 characters</p>
          </div>
            ...
            <div className="flex items-center gap-2 flex-wrap">
              ...
              <div className="flex items-center gap-2">
                <input
                  ...
                  className="w-8 h-8 rounded cursor-pointer bg-transparent border border-white/15"
                />
                <span className="text-xs font-mono text-gray-400/60">{tagColor}</span>
              </div>
            </div>
          </div>
              ...
              {TAG_STYLES.map((style) => (
                ...
                >
                  ...
                  <div className="text-left">
                    ...
                    <div className="text-[10px] text-gray-400/60">{style.description}</div>
                  </div>
                </button>
              ))}
            </div>
