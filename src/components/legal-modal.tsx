...
export function LegalModal({ isOpen, onClose, defaultTab = 'tos' }: LegalModalProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-3xl bg-gradient-to-b from-[#150a25] to-[#0a0510] border-purple-500/20">
        <DialogHeader>
        ...
        <Tabs value={activeTab} onValueChange={(v) => setActiveTab(v as 'tos' | 'privacy' | 'tar')} className="w-full">
          <TabsList className="grid w-full grid-cols-3 bg-purple-900/20 border border-purple-500/15 h-11 mb-4">
            <TabsTrigger value="tos" className="data-[state=active]:bg-purple-500/30 data-[state=active]:text-purple-100 text-purple-400/70 h-9 rounded-md transition-all flex items-center gap-2">
              <FileText className="w-4 h-4" />
              Terms of Service
            </TabsTrigger>
            <TabsTrigger value="privacy" className="data-[state=active]:bg-purple-500/30 data-[state=active]:text-purple-100 text-purple-400/70 h-9 rounded-md transition-all flex items-center gap-2">
              <Shield className="w-4 h-4" />
              Privacy Policy
            </TabsTrigger>
            <TabsTrigger value="tar" className="data-[state=active]:bg-purple-500/30 data-[state=active]:text-purple-100 text-purple-400/70 h-9 rounded-md transition-all flex items-center gap-2">
          ...
          <div className="h-[60vh] overflow-y-auto pr-2 custom-scrollbar">
            <TabsContent value="tos" className="mt-0">
              <div className="space-y-6 text-purple-200/90">
                {/* Header */}
                <div className="bg-purple-900/20 rounded-xl p-4 border border-purple-500/15">
                  <h2 className="text-2xl font-bold text-purple-100 mb-2">Terms of Service</h2>
                  <p className="text-sm text-purple-400/70">Last updated: January 2025</p>
                </div>
                ...
                <section>
                  ...
                  <p className="text-sm leading-relaxed text-purple-300/80">
                ...
                <section>
                  ...
                  <p className="text-sm leading-relaxed text-purple-300/80 mb-3">
                    Chrona is a roleplay universe platform that allows users to:
                  </p>
                  <ul className="list-disc list-inside space-y-2 text-sm text-purple-300/80 ml-2">
            ...
            <TabsContent value="privacy" className="mt-0">
              <div className="space-y-6 text-purple-200/90">
                {/* Header */}
                <div className="bg-purple-900/20 rounded-xl p-4 border border-purple-500/15">
                  <h2 className="text-2xl font-bold text-purple-100 mb-2">Privacy Policy</h2>
                  <p className="text-sm text-purple-400/70">Last updated: January 2025</p>
                </div>

                {/* Intro */}
                <div className="bg-gradient-to-r from-purple-900/30 to-fuchsia-900/20 rounded-xl p-4 border border-purple-500/20">
                  <p className="text-sm leading-relaxed text-purple-300/80">
            ...
            <TabsContent value="tar" className="mt-0">
              <div className="space-y-6 text-purple-200/90">
                {/* Header */}
                <div className="bg-purple-900/20 rounded-xl p-4 border border-purple-500/15">
                  <h2 className="text-2xl font-bold text-purple-100 mb-2">Terms & Rules</h2>
                  <p className="text-sm text-purple-400/70">Community Guidelines for Chrona</p>
                </div>
