...
export function LegalModal({ isOpen, onClose, defaultTab = 'tos' }: LegalModalProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-3xl bg-gradient-to-b from-[#150a25] to-[#0a0510] border-white/15">
        <DialogHeader>
        ...
        <Tabs value={activeTab} onValueChange={(v) => setActiveTab(v as 'tos' | 'privacy' | 'tar')} className="w-full">
          <TabsList className="grid w-full grid-cols-3 bg-gray-900/20 border border-white/10 h-11 mb-4">
            <TabsTrigger value="tos" className="data-[state=active]:bg-white/10 data-[state=active]:text-white text-gray-400/70 h-9 rounded-md transition-all flex items-center gap-2">
              <FileText className="w-4 h-4" />
              Terms of Service
            </TabsTrigger>
            <TabsTrigger value="privacy" className="data-[state=active]:bg-white/10 data-[state=active]:text-white text-gray-400/70 h-9 rounded-md transition-all flex items-center gap-2">
              <Shield className="w-4 h-4" />
              Privacy Policy
            </TabsTrigger>
            <TabsTrigger value="tar" className="data-[state=active]:bg-white/10 data-[state=active]:text-white text-gray-400/70 h-9 rounded-md transition-all flex items-center gap-2">
          ...
          <div className="h-[60vh] overflow-y-auto pr-2 custom-scrollbar">
            <TabsContent value="tos" className="mt-0">
              <div className="space-y-6 text-gray-200/90">
                {/* Header */}
                <div className="bg-gray-900/20 rounded-xl p-4 border border-white/10">
                  ...
                  <p className="text-sm text-gray-400/70">Last updated: January 2025</p>
                </div>
                ...
                <section>
                  ...
                  <p className="text-sm leading-relaxed text-gray-300/80 mb-3">
                    Chrona is a roleplay universe platform that allows users to:
                  </p>
                  <ul className="list-disc list-inside space-y-2 text-sm text-gray-300/80 ml-2">
            ...
            <TabsContent value="privacy" className="mt-0">
              <div className="space-y-6 text-gray-200/90">
                ...
                {/* Intro */}
                <div className="bg-gradient-to-r from-gray-900/30 to-gray-800/20 rounded-xl p-4 border border-white/15">
                  <p className="text-sm leading-relaxed text-gray-300/80">
                ...
                <section>
                  <h3 className="text-lg font-semibold text-white mb-3 flex items-center gap-2">
                    <Shield className="w-4 h-4 text-cyan-400" />
                    10. Age Verification & Accuracy
                  </h3>
                  <p className="text-sm leading-relaxed text-gray-300/80 mb-3">
                    Your date of birth is used to determine age eligibility:
                  </p>
                  <ul className="list-disc list-inside space-y-2 text-sm text-gray-300/80 ml-2">
                    <li><strong>Accurate Information:</strong> You must provide accurate age information</li>
                    <li><strong>False DOB:</strong> Providing a false date of birth to bypass age restrictions is a bannable offence</li>
                    <li><strong>Age-Gated Features:</strong> Some features (NSFW content) are only available to users 18+</li>
                    <li><strong>Staff Review:</strong> Staff may review messages for safety and moderation purposes, particularly where minors are involved</li>
                  </ul>
                </section>
                ...
                <section>
                  ...
                  <p className="text-sm leading-relaxed text-gray-300/80">
                    Chrona is not intended for children under 16. We do not knowingly collect information from children under 16. If you believe a child under 16 has created an account, please contact us. Under the UK Online Safety Act 2023 and similar regulations, we have a duty of care to prevent NSFW content reaching under-18 users.
                  </p>
                </section>
            ...
            <TabsContent value="tar" className="mt-0">
              <div className="space-y-6 text-gray-200/90">
                {/* Header */}
                <div className="bg-gray-900/20 rounded-xl p-4 border border-white/10">
                  <h2 className="text-2xl font-bold text-white mb-2">Terms & Rules</h2>
                  <p className="text-sm text-gray-400/70">Community Guidelines for Chrona</p>
                </div>
