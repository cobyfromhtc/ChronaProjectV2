...
const genreConfig: Record<string, { color: string; bg: string; border: string; gradient: string }> = {
  Fantasy: { color: 'text-gray-400', bg: 'bg-white/10', border: 'border-white/30', gradient: 'from-gray-600/30 to-gray-400/20' },
  ...
  Drama: { color: 'text-gray-300', bg: 'bg-white/10', border: 'border-white/20', gradient: 'from-gray-500/30 to-gray-400/20' },
  ...
  Supernatural: { color: 'text-gray-300', bg: 'bg-white/10', border: 'border-white/20', gradient: 'from-gray-500/30 to-white/20' },
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent 
        className="max-w-2xl max-h-[92vh] p-0 gap-0 overflow-hidden 
                   ...
                   border border-white/15 shadow-2xl shadow-black/30"
      ...
      >
        ...
        <div className="relative h-44 w-full overflow-hidden">
          ...
          <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-white via-gray-300 to-gray-500" />
          
          {/* Server Icon - Positioned better */}
          <div className="absolute -bottom-10 left-6 z-10">
            <div className="relative">
              <Avatar className="h-20 w-20 border-4 border-[#0a0a0a] shadow-xl shadow-black/50 ring-2 ring-white/20">
                <AvatarImage src={displayServer.iconImage || undefined} alt={displayName} />
                <AvatarFallback className="bg-gradient-to-br from-gray-700 to-gray-500 text-white text-2xl font-bold">
          ...
          <div className="px-6 pb-4">
            <div className="flex items-start justify-between gap-4">
              <div className="flex-1 min-w-0">
                ...
                {displayDescription && (
                  <p className="mt-2 text-sm text-gray-200/70 line-clamp-2 leading-relaxed">
                    {displayDescription}
                  </p>
                )}
              </div>
            ...
            {/* Stats Bar - Improved */}
            <div className="flex flex-wrap items-center gap-4 mt-4 py-3 px-4 rounded-xl bg-white/5 border border-white/10">
              <div className="flex items-center gap-2 text-sm">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-400/70">members</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-2 text-sm">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-400/70">{reviewCount} reviews</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-2 text-sm">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-400/70">created</p>
                </div>
              </div>
            </div>
            ...
            {isJoined ? (
              ...
              <button
                ...
                className="w-full py-3 px-4 rounded-xl font-semibold text-sm
                           ...
                           hover:from-white hover:to-gray-400
              ...
              <button
                ...
                className={`flex-1 py-2.5 px-4 rounded-lg text-sm font-medium transition-all duration-200
                           ...
                           ${activeTab === 'details' 
                             ...
                             : 'text-gray-400/70 hover:text-white hover:bg-white/5'}`}
              >
              ...
              <div className="space-y-5">
                ...
                <div>
                  <h4 className="text-sm font-semibold text-gray-200 mb-2 flex items-center gap-2">
                    <div className="w-1 h-4 bg-gradient-to-b from-white to-gray-300 rounded-full" />
                    About
                  </h4>
                  <p className="text-sm text-gray-300/80 leading-relaxed pl-3">
                ...
                <div>
                  ...
                  <ul className="text-sm text-gray-300/70 space-y-2 pl-3">
                    <li className="flex items-start gap-2">
                      <span className="w-5 h-5 rounded bg-white/5 flex items-center justify-center text-xs text-gray-400 flex-shrink-0 mt-0.5">1</span>
                      Be respectful to all members
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="w-5 h-5 rounded bg-white/5 flex items-center justify-center text-xs text-gray-400 flex-shrink-0 mt-0.5">2</span>
                      Stay in character during roleplay sessions
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="w-5 h-5 rounded bg-white/5 flex items-center justify-center text-xs text-gray-400 flex-shrink-0 mt-0.5">3</span>
                      No god-modding or power playing
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="w-5 h-5 rounded bg-white/5 flex items-center justify-center text-xs text-gray-400 flex-shrink-0 mt-0.5">4</span>
                      Follow the community guidelines
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="w-5 h-5 rounded bg-white/5 flex items-center justify-center text-xs text-gray-400 flex-shrink-0 mt-0.5">5</span>
                          ...
                          <Star
                            className={`w-5 h-5 transition-colors ${
                              star <= newReview.rating
                                ...
                                : 'text-gray-500/30 hover:text-amber-400/50'
                            }`}
                          />
                        </button>
                      ))}
                      <span className="ml-2 text-sm text-gray-400/70">
                        {newReview.rating}/5
                      </span>
                    </div>
                    <Textarea
                      ...
                      rows={2}
                      className="bg-white/5 border-white/15 text-white placeholder:text-gray-500/50 resize-none text-sm"
                    />
                    <button
                ...
                {reviews.length === 0 ? (
                  <div className="text-center py-10">
                    <div className="w-14 h-14 mx-auto mb-3 rounded-xl bg-white/5 flex items-center justify-center">
                      <MessageSquare className="w-6 h-6 text-gray-400/50" />
                    </div>
                    <p className="text-gray-400/70 text-sm">No reviews yet</p>
                    <p className="text-gray-500/50 text-xs mt-1">Be the first to share your experience!</p>
                  </div>
                ) : (
                  <div className="space-y-3">
                    {reviews.map((review) => (
                      ...
                      >
                        ...
                        <p className="text-sm text-gray-300/70 leading-relaxed">{review.content}</p>
                        <div className="flex items-center gap-3 mt-3 pt-3 border-t border-white/10">
                          <button className="flex items-center gap-1.5 text-xs text-gray-400/60 hover:text-gray-300 transition-colors">
                          ...
                          <button className="flex items-center gap-1.5 text-xs text-gray-400/60 hover:text-red-400 transition-colors ml-auto">
