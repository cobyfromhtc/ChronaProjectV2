...
const genreConfig: Record<string, { color: string; bg: string; border: string; gradient: string }> = {
  Fantasy: { color: 'text-slate-300', bg: 'bg-teal-500/15', border: 'border-white/[0.10]', gradient: 'from-teal-600/15 to-cyan-600/10' },
  ...
  Adventure: { color: 'text-emerald-300', bg: 'bg-emerald-500/15', border: 'border-emerald-500/25', gradient: 'from-emerald-600/20 to-teal-600/15' },
        ...
        <div className="relative h-52 w-full overflow-hidden">
          ...
          <div className="absolute -bottom-10 left-6 z-10">
            <div className="relative">
              <Avatar className="h-20 w-20 border-4 border-[#0f1117] shadow-xl shadow-black/50 ring-2 ring-white/[0.08]">
                <AvatarImage src={displayServer.iconImage || undefined} alt={displayName} />
                <AvatarFallback className="bg-gradient-to-br from-teal-600 to-cyan-600 text-white text-2xl font-bold">
                  {displayName.charAt(0)}
                </AvatarFallback>
              </Avatar>
              {/* Online indicator */}
              {isJoined && (
                <div className="absolute -bottom-1 -right-1 w-5 h-5 bg-emerald-500 rounded-full border-2 border-[#0f1117] flex items-center justify-center">
              ...
              <div className="flex items-center gap-3 mt-3 text-sm">
                <div className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-white/[0.03] border border-white/[0.08]">
                  ...
                  <Avatar className="h-5 w-5 ring-1 ring-white/[0.08]">
                    ...
                    <AvatarFallback className="text-xs bg-teal-600/50">
              ...
              <div className="space-y-5">
                ...
                <div>
                  <h4 className="text-sm font-semibold text-slate-200 mb-2 flex items-center gap-2">
                    <div className="w-1 h-4 bg-gradient-to-b from-teal-500 to-cyan-400 rounded-full" />
                    About
                  </h4>
                ...
                {displayServer.tags && (
                  <div>
                    <h4 className="text-sm font-semibold text-slate-200 mb-2 flex items-center gap-2">
                      <div className="w-1 h-4 bg-gradient-to-b from-cyan-500 to-blue-400 rounded-full" />
                      Tags
                    </h4>
                        ...
                        <div className="flex items-start justify-between mb-2">
                          <div className="flex items-center gap-2">
                            <Avatar className="h-8 w-8 ring-1 ring-white/[0.08]">
                              ...
                              <AvatarFallback className="bg-teal-600/50 text-xs">
