  ...
  return (
    <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50 p-4" onClick={onClose}>
      ...
      >
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-purple-400 text-sm">by @{listing.creator.username}</span>
              </div>
            </div>
          </div>
        ...
        <div className="px-4 py-3 border-b border-purple-500/15 flex items-center gap-6">
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm">
                <span className="font-semibold text-purple-100">{listing.downloads + listing.purchaseCount}</span>
          ...
          {slotInfo && (
            <div className="flex items-center gap-2 ml-auto text-sm">
              <span className="text-purple-400">Slots:</span>
              <span className={`font-semibold ${hasSlots ? 'text-purple-100' : 'text-red-400'}`}>
              ...
              <div className="grid grid-cols-2 gap-3">
                {persona?.archetype && (
                  <div className="p-3 rounded-lg bg-purple-500/5 border border-purple-500/10">
                    <p className="text-xs text-purple-400/60">Archetype</p>
                    <p className="text-sm font-medium text-purple-100">{persona.archetype}</p>
                  </div>
                )}
                {persona?.gender && (
                  <div className="p-3 rounded-lg bg-purple-500/5 border border-purple-500/10">
                    <p className="text-xs text-purple-400/60">Gender</p>
                    <p className="text-sm font-medium text-purple-100">{persona.gender}</p>
                  </div>
                )}
                {persona?.age !== null && persona?.age !== undefined && (
                  <div className="p-3 rounded-lg bg-purple-500/5 border border-purple-500/10">
                    <p className="text-xs text-purple-400/60">Age</p>
                    <p className="text-sm font-medium text-purple-100">{persona.age}</p>
                  </div>
                )}
                {persona?.species && (
                  <div className="p-3 rounded-lg bg-purple-500/5 border border-purple-500/10">
                    <p className="text-xs text-purple-400/60">Species</p>
        ...
        {/* Footer Actions */}
        <div className="p-4 border-t border-purple-500/10 bg-[#0a0610]">
          {/* Error Messages */}
          {purchaseError && (
          ...
          {listing.isOwner ? (
            <div className="flex items-center justify-center gap-2 py-3 px-4 rounded-lg bg-purple-500/10 text-purple-300 font-medium border border-purple-500/20">
