...
export interface SessionUser {
  ...
  chronos?: number // Optional chronos balance
}
...
// Add account to store and set as active (when adding new account, always switch to it)
export async function addAccountToStore(user: SessionUser, token: string): Promise<AccountsStore> {
  ...
  // Always set the newly added account as active (user is logging in/switching to this account)
